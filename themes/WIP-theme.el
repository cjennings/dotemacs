...
(custom-theme-set-faces
 ...
 '(dashboard-items-face ((t (:inherit widget-button :foreground "#a9b2bb"))))
 ...
 '(flycheck-error-list-info ((t (:foreground "#809c50"))))
 '(flycheck-error-list-error-message ((t (:foreground "#a9b2bb"))))
 '(flycheck-error-list-checker-name ((t (:foreground "#809c50"))))
 '(flycheck-error-list-column-number ((t (:foreground "#a9b2bb"))))
 '(flycheck-error-list-line-number ((t (:foreground "#a9b2bb"))))
 '(flycheck-error-list-filename ((t (:foreground "#a9b2bb"))))
 '(flycheck-error-list-id ((t (:foreground "#a9b2bb"))))
 '(flycheck-error-list-id-with-explainer ((t (:foreground "#a9b2bb"))))
 '(flycheck-error-list-highlight ((t (:background "#363638"))))
 '(flycheck-verify-select-checker ((t (:foreground "#bac1c8"))))
 '(dired-header ((t (:foreground "#54677d" :weight bold))))
 '(dired-directory ((t (:foreground "#788da6" :weight bold :slant italic))))
 '(dired-symlink ((t (:foreground "#777980"))))
 '(dired-broken-symlink ((t (:foreground "#cb6b4d"))))
 '(dired-special ((t (:foreground "#777980"))))
 '(dired-set-id ((t (:foreground "#cb7b64" :weight bold :slant italic))))
 '(dired-perm-write ((t (:foreground "#627b2c" :weight bold :slant italic))))
 '(dired-mark ((t (:foreground "#e6ce88" :background "#4a4b4f"))))
 '(dired-marked ((t (:foreground "#e6ce88" :background "#4a4b4f"))))
 '(dired-flagged ((t (:foreground "#cb6b4d" :weight bold))))
 '(dired-ignored ((t (:foreground "#606267"))))
 '(dired-warning ((t (:foreground "#cb7b64" :weight bold))))
 '(dirvish-inactive ((t (:foreground "#606267"))))
 '(dirvish-free-space ((t (:foreground "#8ca46c"))))
 '(dirvish-hl-line ((t (:foreground "#edeff1" :background "#4a4b4f"))))
 '(dirvish-file-modes ((t (:foreground "#777980"))))
 '(dirvish-file-link-number ((t (:foreground "#777980"))))
 '(dirvish-file-user-id ((t (:foreground "#777980"))))
 '(dirvish-file-group-id ((t (:foreground "#777980"))))
 ...
 '(dirvish-subtree-guide ((t (:foreground "#8e919a"))))
 '(dirvish-subtree-state ((t (:foreground "#8e919a"))))
 '(dirvish-collapse-dir-face ((t (:foreground "#e4eaf8"))))
 '(dirvish-collapse-empty-dir-face ((t (:foreground "#777980"))))
 ...
 '(dirvish-media-info-property-key ((t (:foreground "#8e919a"))))
 ...
 '(dirvish-proc-running ((t (:foreground "#e0c266"))))
 '(dirvish-proc-finished ((t (:foreground "#8ca46c"))))
 ...
 '(dirvish-vc-unregistered-face ((t (:foreground "#7c838a"))))
 ...
 '(cj/nov-reading-sepia ((t (:foreground "#dab53d" :background "#2d2306"))))
 '(cj/nov-reading-dark ((t (:foreground "#ab8d2e"))))
 '(cj/nov-reading-light ((t (:foreground "#100f0f" :background "#a9b2bb"))))
 '(cj/nov-reading-sepia-heading ((t (:inherit cj/nov-reading-sepia :foreground "#67809c" :height 1.2))))
 '(cj/nov-reading-sepia-link ((t (:foreground "#5178db" :underline t))))
 '(cj/nov-reading-dark-heading ((t (:foreground "#67809c"))))
 '(cj/nov-reading-dark-link ((t (:inherit cj/nov-reading-dark :foreground "#5178db" :underline t))))
 '(cj/nov-reading-light-heading ((t (:foreground "#222223"))))
 '(cj/nov-reading-light-link ((t (:foreground "#100f0f" :underline t))))
 '(cj/ai-term-accent ((t (:foreground "#67809c"))))
 '(cj/ai-term-color-red ((t (:foreground "#cb6b4d"))))
 '(cj/ai-term-color-blue ((t (:foreground "#7ba1c5"))))
 '(cj/ai-term-color-green ((t (:foreground "#74932f"))))
 '(cj/ai-term-color-yellow ((t (:foreground "#e6ce88"))))
 '(cj/ai-term-color-purple ((t (:foreground "#9f80c9"))))
 '(cj/ai-term-color-orange ((t (:foreground "#ab8d2e"))))
 '(cj/ai-term-color-pink ((t (:foreground "#c7a8a5"))))
 '(cj/ai-term-color-cyan ((t (:foreground "#88b2c3"))))
 ...
 '(nerd-icons-blue ((t (:foreground "#bac1c8"))))
 '(nerd-icons-blue-alt ((t (:foreground "#bac1c8"))))
 '(nerd-icons-cyan ((t (:foreground "#bac1c8"))))
 '(nerd-icons-cyan-alt ((t (:foreground "#bac1c8"))))
 '(nerd-icons-dblue ((t (:foreground "#cbd0d6"))))
 '(nerd-icons-dcyan ((t (:foreground "#bac1c8"))))
 '(nerd-icons-dgreen ((t (:foreground "#bac1c8"))))
 '(nerd-icons-dmaroon ((t (:foreground "#bac1c8"))))
 '(nerd-icons-dorange ((t (:foreground "#bac1c8"))))
 '(nerd-icons-dpink ((t (:foreground "#bac1c8"))))
 '(nerd-icons-dpurple ((t (:foreground "#bac1c8"))))
 '(nerd-icons-dred ((t (:foreground "#bac1c8"))))
 '(nerd-icons-dsilver ((t (:foreground "#bac1c8"))))
 '(nerd-icons-dyellow ((t (:foreground "#bac1c8"))))
 '(nerd-icons-green ((t (:foreground "#bac1c8"))))
 '(nerd-icons-lblue ((t (:foreground "#bac1c8"))))
 '(nerd-icons-lcyan ((t (:foreground "#bac1c8"))))
 '(nerd-icons-lgreen ((t (:foreground "#bac1c8"))))
 '(nerd-icons-lmaroon ((t (:foreground "#bac1c8"))))
 '(nerd-icons-lorange ((t (:foreground "#bac1c8"))))
 '(nerd-icons-lpink ((t (:foreground "#bac1c8"))))
 '(nerd-icons-lpurple ((t (:foreground "#bac1c8"))))
 '(nerd-icons-lred ((t (:foreground "#bac1c8"))))
 '(nerd-icons-lsilver ((t (:foreground "#bac1c8"))))
 '(nerd-icons-lyellow ((t (:foreground "#bac1c8"))))
 '(nerd-icons-maroon ((t (:foreground "#bac1c8"))))
 '(nerd-icons-orange ((t (:foreground "#bac1c8"))))
 '(nerd-icons-pink ((t (:foreground "#bac1c8"))))
 '(nerd-icons-purple ((t (:foreground "#bac1c8"))))
 '(nerd-icons-purple-alt ((t (:foreground "#bac1c8"))))
 '(nerd-icons-red ((t (:foreground "#bac1c8"))))
 '(nerd-icons-red-alt ((t (:foreground "#bac1c8"))))
 '(nerd-icons-silver ((t (:foreground "#bac1c8"))))
 '(nerd-icons-yellow ((t (:foreground "#bac1c8"))))
 ...
 '(company-tooltip ((t (:foreground "#bac1c8" :background "#54677d" :weight bold))))
 ...
 '(company-tooltip-selection ((t (:foreground "#e6ce88" :background "#54677d" :weight bold))))
 ...
 '(flyspell-correct-highlight-face ((t (:inherit isearch :foreground "#e6ce88" :background "#363638"))))
 ...
 '(highlight-indent-guides-character-face ((t (:foreground "#777980"))))
 '(hl-todo ((t (:foreground "#cb6b4d" :weight bold))))
 '(hl-todo-flymake-type ((t (:foreground "#a85b42" :weight bold))))
 ...
 '(marginalia-documentation ((t (:inherit completions-annotations :foreground "#627b2c"))))
 '(marginalia-file-name ((t (:inherit marginalia-documentation :foreground "#a9b2bb"))))
 '(marginalia-file-owner ((t (:inherit font-lock-preprocessor-face :foreground "#627b2c"))))
 ...
 '(orderless-match-face-0 ((t (:foreground "#dab53d" :weight bold :slant italic))))
 '(orderless-match-face-1 ((t (:foreground "#dab53d" :weight bold :slant italic))))
 '(orderless-match-face-2 ((t (:foreground "#dab53d" :weight bold :slant italic))))
 '(orderless-match-face-3 ((t (:foreground "#dab53d" :weight bold :slant italic))))
 '(org-superstar-first ((t (:inherit org-warning :foreground "#dab53d"))))
 '(org-superstar-header-bullet ((t (:foreground "#dab53d"))))
 '(org-superstar-item ((t (:inherit default :foreground "#dab53d"))))
 '(org-superstar-leading ((t (:inherit default :foreground "#100f0f"))))
 '(prescient-primary-highlight ((t (:foreground "#dab53d"))))
 '(prescient-secondary-highlight ((t (:foreground "#dab53d"))))
