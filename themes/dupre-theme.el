...
(let* ((dupre-fg          (if (display-graphic-p) "#f0fef0" "color-231"))
  ...
  (custom-theme-set-faces
   ...
   (when (>= emacs-major-version 27)
	 ...
	 `(tab-line-tab-current   ((t (:background ,dupre-bg+2 :foreground ,dupre-yellow+1
										  :box (:line-width 4 :color ,dupre-bg+2)))))
	 `(tab-line-highlight     ((t (:background ,dupre-bg+1 :foreground ,dupre-fg
										  :box (:line-width 4 :color ,dupre-bg+1))))))
